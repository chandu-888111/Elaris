  ...
  return (
    <div className="relative min-h-screen overflow-hidden">
      ...
      <section className="relative z-10 mx-auto max-w-7xl px-6 pb-16">
        ...
        >
          {stats.map((s) => (
            <motion.div key={s.l} variants={cardVariants} className="text-center">
      ...
      <section id="faq" className="relative z-10 mx-auto max-w-3xl px-6 py-24">
        ...
        >
          {[
            ...
            [
              "What AI models?",
              "We default to fast Gemini & GPT models via the Spark AI Gateway — no API keys required.",
            ],
            [
      ...
      <footer className="relative z-10 mx-auto max-w-7xl px-6 py-10">
        <div className="flex flex-col items-center justify-between gap-4 border-t border-border pt-8 md:flex-row">
          ...
          <div className="text-xs text-muted-foreground">
            © {new Date().getFullYear()} ProjectSpark — Powered by Spark Intelligence.
          </div>
