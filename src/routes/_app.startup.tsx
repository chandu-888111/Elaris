          ...
          <div className="space-y-6">
            ...
            <HolographicPanel className="p-5 space-y-4">
              <h3 className="font-display text-sm font-bold text-foreground">
                Validate Startup Concept
              </h3>
              <p className="text-xs text-muted-foreground">
                Describe your startup idea to generate a simulated market analysis and Business
                Model Canvas.
              </p>
            ...
            <HolographicPanel className="p-5 flex flex-col justify-between h-[240px]">
              <div>
                ...
                <p className="text-xs text-muted-foreground mt-1">
                  Export slides into a clean PowerPoint/PDF config format.
                </p>
              </div>
