      ...
      <div className="grid gap-6">
                ...
                return (
                  <HolographicPanel key={stage} className="p-4 flex flex-col h-[calc(100vh-210px)]">
                    ...
                    >
                      ...
                      <span className="font-mono text-[10px] bg-white/5 px-2 py-0.5 rounded-full">
                        {stageTasks.length}
                      </span>
                    </div>
                      ...
                      {stageTasks.map((task) => (
                        ...
                        >
                          <div>
                            ...
                            <p className="text-xs text-foreground font-semibold mt-2.5 leading-snug">
                              {task.title}
                            </p>
                          </div>
        ...
        {activeTab === "tracking" && (
          <div className="grid gap-6 md:grid-cols-3 h-[calc(100vh-130px)]">
            ...
            >
              <h3 className="font-display text-sm font-bold text-foreground">
                Record Team Contribution Logs
              </h3>
              <p className="text-xs text-muted-foreground">
                Record a mock activity to update your contribution score and feed logs.
              </p>
              ...
              <div className="mt-4 pt-4 border-t border-white/5 flex-1 flex flex-col min-h-0">
                <div className="text-[10px] font-bold uppercase tracking-wider text-muted-foreground mb-2 shrink-0">
                  ...
                  {contributions.map((contr) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <span className="text-[10px] text-spark font-mono font-bold">
                          +{contr.xpGained} XP
                        </span>
                      </div>
                    );
