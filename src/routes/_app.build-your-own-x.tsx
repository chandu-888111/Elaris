...
const PROJECTS: ProjectChallenge[] = [
  {
    ...
    iconName: "Database",
    description:
      "Build an in-memory, key-value store implementing the Redis Serialization Protocol (RESP).",
    xpValue: 400,
    steps: [
      {
        id: "r1",
  ...
  },
  {
    ...
    iconName: "GitBranch",
    description:
      "Write a version control tracker that initializes a repository, builds object hashes, compresses content, and reconstructs commit trees.",
    xpValue: 500,
    steps: [
      {
        id: "g1",
  ...
  },
  {
    ...
    iconName: "Table",
    description:
      "Implement a SQL parser, virtual machine compiler, and file-serialized B-Tree layout to retrieve and persist database rows.",
    xpValue: 600,
    steps: [
      {
        id: "s1",
  ...
  },
  {
    ...
    iconName: "Network",
    description:
      "Write a UDP server that binds to port 53, parses query packet payloads, indexes domains, and delegates recursive lookup requests.",
    xpValue: 350,
    steps: [
      {
        id: "d1",
...
export function BuildYourOwnX() {
  ...
  const currentSnippet = selectedProj
    ? selectedProj.snippets[selectedLang] || "// No snippet available for this language."
    : "";
      ...
      <div className="space-y-4 animate-in fade-in duration-300">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div className="text-[10px] font-bold uppercase tracking-widest text-muted-foreground flex items-center gap-1.5">
            ...
            <span>
              Parsed Catalog (
              {getFilteredCustomProjects().length + getFilteredLiveTutorials().length} guides)
            </span>
        ...
        <div className="grid gap-6 md:grid-cols-[260px_1fr] items-start">
          ...
          >
            ...
            >
              {categories.map((cat) => {
                const IconComp = (Icons[CATEGORY_ICONS[cat] || "Cpu"] ||
                  Icons.Cpu) as React.ComponentType<{ className?: string }>;
                return (
                  <button
                    key={cat}
                    onClick={() => {
          ...
          <div className="grid gap-6 lg:grid-cols-[280px_1fr] items-start">
            ...
            <div className="flex flex-col md:sticky md:top-6 md:h-[calc(100vh-48px)] w-full">
              <div className="text-[9px] uppercase tracking-widest font-bold text-muted-foreground shrink-0 mb-4">
                Tutorial Guides
              </div>
              <div
              ...
              >
                ...
                {getFilteredCustomProjects().map((proj) => {
                  ...
                  const ChallengeIcon = (Icons[proj.iconName] || Icons.Cpu) as React.ComponentType<{
                    className?: string;
                  }>;
                    ...
                    >
                      <div className="flex items-center gap-2.5">
                        ...
                        <div className="min-w-0 flex-1">
                          ...
                          <span className="text-[8px] font-bold text-purple-400 bg-purple-500/10 border border-purple-500/20 px-1.5 py-0.2 rounded mt-1 inline-block uppercase">
                            Interactive
                          </span>
                        </div>
                      </div>
                ...
                {getFilteredCustomProjects().length === 0 &&
                  getFilteredLiveTutorials().length === 0 && (
                  ...
                  <div className="space-y-5 pr-1">
                    <div>
                      ...
                      <p className="text-xs text-muted-foreground leading-relaxed mt-2">
                        This is a step-by-step programming tutorial parsed from the official
                        codecrafters Build Your Own X library. Follow this external repository guide
                        to construct this software component from scratch.
                      </p>
                    </div>
              ...
              {selectedProj && !selectedTutorial && (
                ...
                >
                  <div className="space-y-5 pr-1">
                    ...
                    <div className="space-y-2.5">
                      <label className="text-[9px] font-bold uppercase tracking-widest text-muted-foreground flex items-center gap-1">
                        <Icons.CheckSquare className="h-3.5 w-3.5 text-spark" /> Implementation
                        Checklist
                      </label>
                            ...
                            >
                              ...
                              <div className="min-w-0 flex-1">
                                <div className="flex items-center gap-1.5">
                                  ...
                                  <span className="text-[8px] font-mono font-bold text-purple-400 bg-purple-500/10 border border-purple-500/10 px-1 rounded">
                                    +{stepXp} XP
                                  </span>
                                </div>
