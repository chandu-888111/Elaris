...
export type RoadmapNode = {
  ...
  quizzes?: string[]; // Array of quiz questions or topics
    ...
    beginner: [
        ...
        projects: [
          {
            ...
            brief:
              "Write an ArrayList from scratch with push, pop, insert, delete, and automatic doubling.",
            difficulty: "easy",
          },
        ],
      },
      {
        ...
        resources: [
          ...
          },
          {
            ...
            url: "https://www.youtube.com/watch?v=H5J1LH8y3SY",
            videoId: "H5J1LH8y3SY",
        ...
        projects: [
          {
            ...
            brief:
              "Implement insertAtHead, insertAtTail, deleteNode, reverseList, and detectCycle.",
            difficulty: "easy",
          },
        ],
      },
      {
        ...
        resources: [
          {
            type: "doc",
            title: "Wikipedia: Stack & Queue",
            url: "https://en.wikipedia.org/wiki/Stack_(abstract_data_type)",
            free: true,
          },
          {
            type: "youtube",
            title: "Stacks & Queues in 10 minutes",
            url: "https://www.youtube.com/watch?v=zLKPMc84aGA",
            videoId: "zLKPMc84aGA",
            channel: "Programming with Mosh",
            free: true,
          },
        ...
        projects: [
          {
            ...
            brief:
              "Write a program that uses a stack to parse strings and check for balanced brackets.",
            difficulty: "easy",
          },
        ],
      },
      {
        ...
        projects: [
          {
            title: "Sorting Visualizer Console App",
            brief:
              "Write an interactive console app highlighting swaps in Bubble, Selection, and Insertion sorts.",
            difficulty: "easy",
          },
        ],
      },
      {
        ...
        resources: [
          ...
          },
          {
            ...
            url: "https://www.youtube.com/watch?v=V_T5upbL27o",
            videoId: "V_T5upbL27o",
            channel: "mycodeschool",
            free: true,
          },
        ...
        projects: [
          {
            title: "Rotated Sorted Array Searcher",
            brief:
              "Find the index of an element in a sorted array that has been rotated, using binary search.",
            difficulty: "medium",
          },
        ],
      },
    ...
    intermediate: [
      {
        ...
        projects: [
          {
            title: "BST Operations Library",
            brief: "Implement insert, delete, search, getHeight, and validateBST functionality.",
            difficulty: "medium",
          },
        ],
      },
      {
        ...
        resources: [
          ...
          },
          {
            ...
            url: "https://www.youtube.com/watch?v=NEtwJAS48QE",
            videoId: "NEtwJAS48QE",
            channel: "Abdul Bari",
            free: true,
          },
        ...
        projects: [
          {
            title: "K-Way Merge Solver",
            brief:
              "Merge K sorted lists into a single sorted list using a Min-Heap/Priority Queue.",
            difficulty: "medium",
          },
        ],
      },
        ...
        projects: [
          {
            ...
            brief:
              "Build a grid maze solver that finds the shortest path from start to end using BFS.",
            difficulty: "medium",
          },
        ],
      },
      {
        ...
        prerequisites: [],
        outcome:
          "Create a hash map with collision resolution strategies (chaining or open addressing).",
        hours: 8,
        difficulty: "medium",
        ...
        resources: [
          ...
          },
          {
            ...
            url: "https://www.youtube.com/watch?v=zHi5v78W1w0",
            videoId: "zHi5v78W1w0",
            channel: "freeCodeCamp",
            free: true,
          },
        ...
        projects: [
          {
            ...
            brief:
              "Write a Hash Map from scratch with custom hash function, resizing, and chaining.",
            difficulty: "medium",
          },
        ],
      },
      {
        ...
        resources: [
          {
            type: "doc",
            title: "Merge & Quick Sort Analysis",
          ...
          },
          {
            ...
            url: "https://www.youtube.com/watch?v=PrxQlI1Rfi0",
            videoId: "PrxQlI1Rfi0",
            channel: "Abdul Bari",
            free: true,
          },
        ...
        projects: [
          {
            title: "Pivot Optimization benchmark",
            brief:
              "Compare Quick Sort performance using first-element, last-element, and median-of-three pivot strategies.",
            difficulty: "medium",
          },
        ],
      },
    ...
    advanced: [
      {
        ...
        projects: [
          {
            title: "Knapsack Solver & Visualizer",
            brief:
              "Build an interactive tool that solves the 0/1 Knapsack problem using tabulation, displaying the matrix step-by-step.",
            difficulty: "hard",
          },
        ],
      },
      {
        ...
        resources: [
          {
            type: "doc",
            title: "Dijkstra's Algorithm Overview",
        ...
        projects: [
          {
            ...
            brief:
              "Simulate a router network finding shortest paths and adapting dynamically when a node goes offline.",
            difficulty: "hard",
          },
        ],
      },
      {
        ...
        resources: [
          ...
          {
            type: "youtube",
            title: "Trie Insert and Search Tutorial",
            url: "https://www.youtube.com/watch?v=m9ZaXPwlh10",
            videoId: "m9ZaXPwlh10",
            channel: "Tushar Roy",
            free: true,
          },
        ...
        projects: [
          {
            ...
            brief:
              "Build a memory-efficient autocomplete system that returns suggestion words based on prefix query in real time.",
            difficulty: "hard",
          },
        ],
      },
      {
        ...
        resources: [
          {
            type: "doc",
            title: "Segment Trees Guide",
            url: "https://cp-algorithms.com/data_structures/segment_tree.html",
            free: true,
          },
          {
            type: "youtube",
            title: "Segment Tree Structure and Queries",
            url: "https://www.youtube.com/watch?v=2Fsg3pU_rQA",
            videoId: "2Fsg3pU_rQA",
            channel: "Tushar Roy",
            free: true,
          },
        ...
        projects: [
          {
            title: "Dynamic Range Sum Resolver",
            brief:
              "Build a system that handles thousands of numerical range queries and updates on a large floating list.",
            difficulty: "hard",
          },
        ],
      },
      {
        ...
        resources: [
          {
            type: "doc",
            title: "Bit Manipulation wiki",
            url: "https://en.wikipedia.org/wiki/Bit_manipulation",
            free: true,
          },
          {
            type: "youtube",
            title: "Bit Manipulation Course",
            url: "https://www.youtube.com/watch?v=Db8OlplTMp8",
            videoId: "Db8OlplTMp8",
            channel: "freeCodeCamp",
            free: true,
          },
        ...
        projects: [
          {
            title: "Custom BitSet Class",
            brief:
              "Implement a Space-efficient BitSet class mapping indices to single bits, with intersection and union.",
            difficulty: "hard",
          },
        ],
      },
  ...
  "computer-vision": {
    beginner: [
      {
        ...
        prerequisites: [],
        outcome:
          "Load images, read matrix channels, and convert color representations using Python.",
        hours: 8,
        difficulty: "easy",
        ...
        resources: [
          {
            type: "doc",
            title: "OpenCV Core Documentation",
            url: "https://docs.opencv.org/4.x/d9/df8/tutorial_root.html",
            free: true,
          },
          {
            type: "youtube",
            title: "Computer Vision Course - Image Basics",
        ...
        projects: [
          {
            title: "Color Filter App",
            brief:
              "Write a script that isolates specific colored objects (e.g. green balls) using HSV color space thresholds.",
            difficulty: "easy",
          },
        ],
      },
      {
        ...
        outcome:
          "Apply Gaussian, Median, and Bilateral filters and write a 2D convolution from scratch.",
        hours: 10,
        difficulty: "easy",
        ...
        projects: [
          {
            title: "Custom Convolution Engine",
            brief:
              "Write a pure NumPy convolution function applying edge-detection and sharpening kernels.",
            difficulty: "easy",
          },
        ],
      },
      {
        ...
        outcome:
          "Apply Sobel and Canny edge detectors and extract/draw contour shapes from images.",
        hours: 10,
        difficulty: "easy",
        ...
        resources: [
          ...
          {
            type: "youtube",
            title: "Canny Edge Detection & Contours",
            url: "https://www.youtube.com/watch?v=de9Wq3yK9fs",
            videoId: "de9Wq3yK9fs",
            channel: "freeCodeCamp",
            free: true,
        ...
        projects: [
          {
            ...
            brief:
              "Given a photo of a document, detect edges, isolate the outline contour, and apply a perspective warp.",
            difficulty: "medium",
          },
        ],
      },
    ...
    intermediate: [
        ...
        resources: [
          {
            ...
            url: "https://docs.opencv.org/4.x/db/d27/tutorial_py_table_of_contents_feature2d.html",
            free: true,
          },
          {
            type: "youtube",
            title: "Feature Matching & Alignment",
            url: "https://www.youtube.com/watch?v=de9Wq3yK9fs",
            videoId: "de9Wq3yK9fs",
            channel: "freeCodeCamp",
            free: true,
        ...
        projects: [
          {
            ...
            brief:
              "Align and stitch two overlapping photos into a single widescreen panorama using keypoint matching and homography.",
            difficulty: "medium",
          },
        ],
      },
      {
        ...
        outcome:
          "Extract HOG/LBP features from images and train a classifier to recognize objects.",
        hours: 12,
        difficulty: "medium",
        ...
        interviewTopics: [
          ...
          "Classical vs Deep Learning vision pipelines",
        ],
        resources: [
          {
            type: "doc",
            title: "scikit-image HOG reference",
        ...
        projects: [
          {
            ...
            brief:
              "Train a Support Vector Machine on HOG features to classify images as 'pedestrian' or 'background'.",
            difficulty: "medium",
          },
        ],
      },
      {
        ...
        resources: [
          ...
          {
            type: "youtube",
            title: "CNNs Explained Intuitively",
        ...
        projects: [
          {
            title: "Custom MNIST Classifier",
            brief:
              "Build a PyTorch CNN class to classify handwritten digits with validation scoring and model checkpoints.",
            difficulty: "medium",
          },
        ],
      },
    ...
    advanced: [
      {
        ...
        resources: [
          ...
          },
          {
            ...
            url: "https://www.youtube.com/watch?v=ag3DLK31yRE",
            videoId: "ag3DLK31yRE",
        ...
        projects: [
          {
            title: "Real-time Webcam Detector",
            brief:
              "Build a Python program streaming webcam frames through YOLO, drawing bounding boxes and labels at >30 FPS.",
            difficulty: "hard",
          },
        ],
      },
      {
        ...
        resources: [
          {
            type: "doc",
            title: "U-Net Paper & Architectures",
        ...
        projects: [
          {
            title: "Self-Driving Road Segmenter",
            brief:
              "Train a U-Net model on road imagery to segments drivable lane regions from surrounding backgrounds.",
            difficulty: "hard",
          },
        ],
      },
      {
        ...
        prerequisites: [],
        outcome:
          "Understand patch projections, self-attention in grids, and apply pretrained ViTs.",
        hours: 15,
        difficulty: "hard",
        skills: ["Vision Transformers", "Attention Mechanisms", "Patch Embeddings"],
        tools: ["Hugging Face", "PyTorch"],
        interviewTopics: [
          "ViT inductive bias vs CNNs",
          "Attention complexity with respect to patch counts",
        ],
        resources: [
          {
            type: "doc",
            title: "Hugging Face ViT docs",
            url: "https://huggingface.co/docs/transformers/model_doc/vit",
            free: true,
          },
          {
            type: "youtube",
            title: "Vision Transformers (ViTs) Explained",
            url: "https://www.youtube.com/watch?v=qU7wO0Fi5gc",
            videoId: "qU7wO0Fi5gc",
            channel: "Outlier",
            free: true,
          },
        ...
        projects: [
          {
            title: "Fine-tuned ViT Classifier",
            brief:
              "Fine-tune a Google ViT model from Hugging Face on a custom dataset (e.g. flower categories).",
            difficulty: "hard",
          },
        ],
      },
    ...
    beginner: [
      {
        ...
        resources: [
          {
            ...
            url: "https://developer.mozilla.org/docs/Web/HTTP/Overview",
            free: true,
          },
          {
            type: "youtube",
            title: "HTTP Protocols & Servers",
        ...
        projects: [
          {
            title: "CLI Request Maker",
            brief:
              "Write a command-line tool that fetches data from an API, parses headers, and displays body metrics.",
            difficulty: "easy",
          },
        ],
      },
      {
        ...
        projects: [
          {
            title: "Interactive Bash Script",
            brief:
              "Create a deployment automation script checking server status, cloning a repo, and launching it.",
            difficulty: "easy",
          },
        ],
      },
      {
        ...
        resources: [
          ...
          {
            type: "youtube",
            title: "Database Design & SQL Course",
            url: "https://www.youtube.com/watch?v=ztHopE5Wubs",
            videoId: "ztHopE5Wubs",
            channel: "freeCodeCamp",
            free: true,
          },
        ...
        projects: [
          {
            ...
            brief:
              "Design and implement tables for users, orders, and products with referential integrity.",
            difficulty: "easy",
          },
        ],
      },
    ...
    intermediate: [
      {
        ...
        resources: [
          ...
          },
          {
            ...
            url: "https://www.youtube.com/watch?v=tN6o8tC2nSA",
            videoId: "tN6o8tC2nSA",
            channel: "freeCodeCamp",
            free: true,
          },
        ...
        projects: [
          {
            ...
            brief:
              "Build an API supporting CRUD operations, query-parameter filters, and server-side logging.",
            difficulty: "medium",
          },
        ],
      },
      {
        ...
        outcome:
          "Implement secure user registration, password hashing (bcrypt), and JWT token auth.",
        hours: 12,
        difficulty: "medium",
        ...
        projects: [
          {
            title: "Secure User Gateway",
            brief:
              "Build a Node/Express service with user login, JWT tokens, and route authorization protection.",
            difficulty: "medium",
          },
        ],
      },
      {
        ...
        prerequisites: [],
        outcome:
          "Write Dockerfiles, build container images, and run multi-container applications with Docker Compose.",
        hours: 10,
        difficulty: "medium",
        ...
        resources: [
          ...
          },
          {
            ...
            url: "https://www.youtube.com/watch?v=3c-iKanqeec",
            videoId: "3c-iKanqeec",
        ...
        projects: [
          {
            title: "Dockerized API with DB",
            brief:
              "Write a Docker Compose file to run a backend container linked with a PostgreSQL container.",
            difficulty: "medium",
          },
        ],
      },
    ...
    advanced: [
      {
        ...
        resources: [
          ...
          },
          {
            ...
            url: "https://www.youtube.com/watch?v=jgpVd5Y7Gx4",
            videoId: "jgpVd5Y7Gx4",
            channel: "freeCodeCamp",
            free: true,
          },
        ...
        projects: [
          {
            ...
            brief:
              "Build a microservice caching geocode endpoints in Redis for 10 minutes to minimize external calls.",
            difficulty: "hard",
          },
        ],
      },
      {
        ...
        prerequisites: [],
        outcome:
          "Build a producer-consumer system decoupling user requests from heavy data processing.",
        hours: 14,
        difficulty: "hard",
        ...
        resources: [
          ...
          {
            type: "youtube",
            title: "Message Brokers Explained",
            url: "https://www.youtube.com/watch?v=tN6o8tC2nSA",
            videoId: "tN6o8tC2nSA",
            channel: "freeCodeCamp",
            free: true,
        ...
        projects: [
          {
            ...
            brief:
              "An API receives receipt details, pushes to RabbitMQ, and a background worker generates and saves the PDF.",
            difficulty: "hard",
          },
        ],
      },
      {
        ...
        prerequisites: [],
        outcome:
          "Configure Nginx as a reverse proxy, set up load balancing, and design a microservices system.",
        hours: 15,
        difficulty: "hard",
        ...
        resources: [
          ...
          },
          {
            ...
            url: "https://www.youtube.com/watch?v=dBGfXw8tWjE",
            videoId: "dBGfXw8tWjE",
            channel: "ByteByteGo",
            free: true,
          },
        ...
        projects: [
          {
            title: "Load-Balanced API cluster",
            brief:
              "Configure Nginx to route incoming traffic across three identical instances of your backend Node service.",
            difficulty: "hard",
          },
        ],
      },
    ...
    beginner: [
      {
        ...
        prerequisites: [],
        outcome:
          "Build clean, accessible web layouts using Flexbox, CSS Grid, and responsive media queries.",
        hours: 10,
        difficulty: "easy",
        ...
        resources: [
          ...
          },
          {
            ...
            url: "https://www.youtube.com/watch?v=3YW-Jv-9V8Y",
            videoId: "3YW-Jv-9V8Y",
        ...
        projects: [
          {
            ...
            brief:
              "Build an interactive product card grid that shifts seamlessly from mobile screens to multi-column desktop.",
            difficulty: "easy",
          },
        ],
      },
      {
        ...
        outcome:
          "Write modern ES6+ JS: destructuring, modules, array filters, and DOM manipulation.",
        hours: 12,
        difficulty: "easy",
        ...
        resources: [
          {
            type: "doc",
            title: "JavaScript.info Reference",
        ...
        projects: [
          {
            title: "Weather Tracker (Vanilla JS)",
            brief:
              "Fetch temperature details from an open API, update DOM elements, and support location searches.",
            difficulty: "easy",
          },
        ],
      },
    ...
    intermediate: [
      {
        ...
        outcome:
          "Understand JSX, render components, pass props, and manage state/effects in React.",
        hours: 15,
        difficulty: "medium",
        ...
        projects: [
          {
            ...
            brief:
              "Build an app featuring dynamic state tracking: adding items, adjusting quantities, and rendering totals.",
            difficulty: "medium",
          },
        ],
      },
      {
        ...
        projects: [
          {
            title: "Admin Panel Dashboard mockup",
            brief:
              "Create a complex dashboard featuring menus, graphs, sidebar grids, and dark modes using Tailwind CSS.",
            difficulty: "medium",
          },
        ],
      },
    ...
    advanced: [
      {
        ...
        prerequisites: [],
        outcome:
          "Audit applications with Lighthouse, implement lazy loading, and optimize bundles.",
        hours: 12,
        difficulty: "hard",
        ...
        resources: [
          ...
          },
          {
            ...
            url: "https://www.youtube.com/watch?v=zJSY8tJY_3M",
            videoId: "zJSY8tJY_3M",
            channel: "freeCodeCamp",
            free: true,
          },
        ...
        projects: [
          {
            title: "Bundle Optimization Audits",
            brief:
              "Take an unoptimized web project, split code paths, compress images, and raise Lighthouse scores from 40 to 95.",
            difficulty: "hard",
          },
        ],
      },
      {
        ...
        outcome:
          "Build a Next.js App Router project utilizing Server Components and Server Actions.",
        hours: 15,
        difficulty: "hard",
        skills: [
          "Server Components",
        ...
        resources: [
          ...
          },
          {
            ...
            url: "https://www.youtube.com/watch?v=wmEsleV16qdo",
            videoId: "wmEsleV16qdo",
        ...
        projects: [
          {
            title: "SSR Blog with Search",
            brief:
              "Build a blog that renders metadata server-side and uses dynamic static paths for rapid article loads.",
            difficulty: "hard",
          },
        ],
      },
    ...
    beginner: [
      {
        ...
        prerequisites: [],
        outcome:
          "Write shell scripts automating file backup, system monitoring, and installation commands.",
        hours: 8,
        difficulty: "easy",
        ...
        resources: [
          ...
          {
            type: "youtube",
            title: "Linux Course for Beginners",
        ...
        projects: [
          {
            title: "Automated Syslog Checker",
            brief:
              "Write a bash script checking system log files for critical failures and emailing reports when found.",
            difficulty: "easy",
          },
        ],
      },
    ...
    intermediate: [
      {
        ...
        projects: [
          {
            title: "Multi-container Application Setup",
            brief:
              "Build a Docker Compose recipe coordinating a Node web app, a Redis cache, and a PostgreSQL database.",
            difficulty: "medium",
          },
        ],
      },
      {
        ...
        projects: [
          {
            title: "Automatic Build & Deploy pipeline",
            brief:
              "Write a GitHub Actions file that runs tests, builds a Docker image, and pushes it to Docker Hub on branch updates.",
            difficulty: "medium",
          },
        ],
      },
      {
        ...
        prerequisites: [],
        outcome:
          "Write Terraform files creating VPCs, security groups, and server instances on AWS.",
        hours: 12,
        difficulty: "medium",
        ...
        projects: [
          {
            title: "Modular AWS Web Infra",
            brief:
              "Write Terraform config setting up a secure subnet, spinning up an EC2 instance, and attaching a public IP.",
            difficulty: "medium",
          },
        ],
      },
    ...
    advanced: [
      {
        ...
        prerequisites: ["do-int-docker"],
        outcome:
          "Write Kubernetes manifests configuring Pods, Deployments, Services, and ingress paths.",
        hours: 20,
        difficulty: "hard",
        ...
        projects: [
          {
            title: "Local Cluster Web Deploy",
            brief:
              "Deploy an Express API container cluster on Minikube with load balancing and rolling update policies.",
            difficulty: "hard",
          },
        ],
      },
      {
        ...
        prerequisites: [],
        outcome:
          "Integrate Prometheus scraper configurations and display telemetry metrics inside Grafana dashboards.",
        hours: 12,
        difficulty: "hard",
        ...
        projects: [
          {
            title: "Telemetry Grafana Dashboard",
            brief:
              "Expose query time metrics on a backend API, scrape via Prometheus, and build a Grafana analytics dashboard.",
            difficulty: "hard",
          },
        ],
      },
    ...
    beginner: [
      {
        ...
        projects: [
          {
            title: "Topology Architecture Diagram",
            brief:
              "Design a full system topology map highlighting DNS lookups, CDNs, load balancers, web instances, and DB layers.",
            difficulty: "easy",
          },
        ],
      },
      {
        ...
        outcome:
          "Compare costs, complexity, and performance tradeoffs when scaling web application workloads.",
        hours: 6,
        difficulty: "easy",
        ...
        interviewTopics: [
          ...
          "Stateless servers in horizontal scaling",
        ],
        resources: [
          {
            type: "doc",
            title: "Scaling Web Apps guide",
            url: "https://github.com/donnemartin/system-design-primer#horizontal-scaling",
            free: true,
          },
          {
            type: "youtube",
        ...
        projects: [
          {
            title: "System Capacity Estimator",
            brief:
              "Calculate server CPU, RAM, and bandwidth requirements to support 10 million daily active users.",
            difficulty: "easy",
          },
        ],
      },
    ...
    intermediate: [
      {
        ...
        outcome:
          "Select and configure routing algorithms (round robin, least connections) using Nginx.",
        hours: 10,
        difficulty: "medium",
        ...
        projects: [
          {
            title: "Nginx Load Balanced Cluster",
            brief:
              "Write an Nginx config routing client traffic to three Express backend servers running locally.",
            difficulty: "medium",
          },
        ],
      },
      {
        ...
        projects: [
          {
            title: "Cache-Aside Data Optimizer",
            brief:
              "Build an API middleware that checks Redis first and falls back to a mock database, logging hit/miss statistics.",
            difficulty: "medium",
          },
        ],
      },
    ...
    advanced: [
      {
        ...
        resources: [
          {
            type: "doc",
            title: "Microservice patterns guide",
        ...
        projects: [
          {
            title: "Microservices Communication demo",
            brief:
              "Build an order service communicating with an inventory service via gRPC messages.",
            difficulty: "hard",
          },
        ],
      },
      {
        ...
        prerequisites: [],
        outcome:
          "Analyze distributed consensus models (Raft/Paxos) and database properties (ACID vs BASE).",
        hours: 15,
        difficulty: "hard",
        ...
        projects: [
          {
            ...
            brief:
              "Write a small visualization demonstrating leader election and data replication across three local nodes.",
            difficulty: "hard",
          },
        ],
      },
        ...
        projects: [
          {
            ...
            brief:
              "Write a calculator module supporting basic mathematical inputs and printing results.",
            difficulty: "easy",
          },
        ],
      },
    ...
    intermediate: [
      {
        ...
        outcome:
          "Write Promises, handle errors via try/catch, and load remote API data using async/await.",
        hours: 10,
        difficulty: "medium",
        ...
        resources: [
          {
            type: "doc",
            title: "MDN Promises guide",
            url: "https://developer.mozilla.org/docs/Web/JavaScript/Guide/Using_promises",
            free: true,
          },
          {
            type: "youtube",
            title: "Asynchronous JavaScript tutorial",
            url: "https://www.youtube.com/watch?v=OSr10Shcgz4",
            videoId: "OSr10Shcgz4",
            channel: "Net Ninja",
            free: true,
          },
        ...
        projects: [
          {
            title: "Giphy API browser",
            brief:
              "Build an interface that fetches trending GIFs from the Giphy API and updates image nodes asynchronously.",
            difficulty: "medium",
          },
        ],
      },
    ...
    advanced: [
      {
        ...
        projects: [
          {
            title: "Encapsulated State Factory",
            brief:
              "Write a function returning getter/setter functions protecting internal variable objects from direct mutations.",
            difficulty: "hard",
          },
        ],
      },
    ...
    beginner: [
      {
        ...
        projects: [
          {
            title: "Strict Calculator script",
            brief:
              "Refactor a JS calculation module to strict TS with typed arguments and return signatures.",
            difficulty: "easy",
          },
        ],
      },
    ...
    intermediate: [
      {
        ...
        resources: [
          ...
          },
          {
            ...
            url: "https://www.youtube.com/watch?v=a_mXG1_8XpU",
            videoId: "a_mXG1_8XpU",
            channel: "Matt Pocock",
            free: true,
          },
        ...
        projects: [
          {
            ...
            brief:
              "Write an API client class wrapping fetch calls returning strictly-typed JSON responses.",
            difficulty: "medium",
          },
        ],
      },
    ...
    advanced: [
      {
        ...
        resources: [
          {
            type: "doc",
            title: "TS Utility Types Reference",
            url: "https://www.typescriptlang.org/docs/handbook/utility-types.html",
            free: true,
          },
          {
            type: "youtube",
            title: "TypeScript Wizardry tutorial",
            url: "https://www.youtube.com/watch?v=a_mXG1_8XpU",
            videoId: "a_mXG1_8XpU",
            channel: "Matt Pocock",
            free: true,
        ...
        projects: [
          {
            title: "Dynamic DB Update type mapper",
            brief:
              "Write types mapped from schemas where ID is mandatory, some fields are read-only, and updates are Partial.",
            difficulty: "hard",
          },
        ],
      },
    ...
    beginner: [
      {
        ...
        resources: [
          ...
          },
          {
            ...
            url: "https://www.youtube.com/watch?v=VyW3Uxgpx-4",
            videoId: "VyW3Uxgpx-4",
            channel: "3Blue1Brown",
            free: true,
          },
        ...
        projects: [
          {
            title: "Perceptron Logic Solver",
            brief:
              "Write a perceptron class in Python that learns AND/OR logic gates after training on truth tables.",
            difficulty: "easy",
          },
        ],
      },
    ...
    intermediate: [
      {
        ...
        projects: [
          {
            title: "Regression Network from Scratch",
            brief:
              "Build a multi-layer neural network using only NumPy, implementing forward, backward, and weight update loops.",
            difficulty: "medium",
          },
        ],
      },
    ...
    advanced: [
      {
        ...
        resources: [
          ...
          {
            type: "youtube",
            title: "Transformers Neural Network tutorial",
            url: "https://www.youtube.com/watch?v=VyW3Uxgpx-4",
            videoId: "VyW3Uxgpx-4",
            channel: "3Blue1Brown",
            free: true,
        ...
        projects: [
          {
            title: "Micro-GPT Text Generator",
            brief:
              "Implement a small decoder-only Transformer model in PyTorch and train it on a short text file to generate prose.",
            difficulty: "hard",
          },
        ],
      },
    ...
    beginner: [
      {
        ...
        prerequisites: [],
        outcome:
          "Query commercial APIs (OpenAI, Gemini), configure temperature settings, and manage tokens.",
        hours: 6,
        difficulty: "easy",
        ...
        resources: [
          {
            type: "doc",
            title: "Google Generative AI guides",
        ...
        projects: [
          {
            title: "Interactive Translation Chatbot",
            brief:
              "Write a script calling the Gemini API that translates input text into a user-specified language, with validation logging.",
            difficulty: "easy",
          },
        ],
      },
    ...
    intermediate: [
      {
        ...
        outcome:
          "Slice documents, create vector embeddings, index them in a DB, and query databases to augment prompts.",
        hours: 12,
        difficulty: "medium",
        ...
        resources: [
          {
            type: "doc",
            title: "LangChain RAG overview",
            url: "https://python.langchain.com/docs/use_cases/question_answering/",
            free: true,
          },
          {
            type: "youtube",
            title: "RAG Explained by LangChain",
        ...
        projects: [
          {
            title: "Q&A PDF Bot",
            brief:
              "Build an application loading text from a PDF, chunking it, indexing it in ChromaDB, and answering queries via Gemini.",
            difficulty: "medium",
          },
        ],
      },
    ...
    advanced: [
      {
        ...
        outcome:
          "Build multi-step agents utilizing tool binding (Function Calling) and loop controls.",
        hours: 15,
        difficulty: "hard",
        ...
        projects: [
          {
            title: "Automated Researcher Agent",
            brief:
              "Build an agent that receives a topic, calls a search tool, compiles citations, and prints a Markdown summary.",
            difficulty: "hard",
          },
        ],
      },
    ...
    beginner: [
      {
        ...
        resources: [
          ...
          },
          {
            ...
            url: "https://www.youtube.com/watch?v=z5rHp2X9BHM",
            videoId: "z5rHp2X9BHM",
            channel: "freeCodeCamp",
            free: true,
          },
        ...
        projects: [
          {
            title: "Network traffic auditor",
            brief:
              "Use Wireshark to capture local HTTP requests, locate plaintext parameters, and document leak vulnerabilities.",
            difficulty: "easy",
          },
        ],
      },
    ...
    intermediate: [
      {
        ...
        projects: [
          {
            title: "Penetration Audit Report",
            brief:
              "Audit a mockup web app, perform SQL injection tests, patch input queries, and write a mitigation report.",
            difficulty: "medium",
          },
        ],
      },
    ...
    advanced: [
      {
        ...
        outcome:
          "Run network exploit simulations, escalate privileges, and document remediation paths.",
        hours: 15,
        difficulty: "hard",
        ...
        projects: [
          {
            title: "Vulnerable VM Exploit Lab",
            brief:
              "Configure a local virtual network, scan an unpatched OS container, run an exploit module, and patch the service.",
            difficulty: "hard",
          },
        ],
      },
    ...
    intermediate: [
      {
        ...
        prerequisites: [],
        outcome:
          "Train, evaluate, and tune Random Forest and SVM models on classification/regression tasks.",
        hours: 14,
        difficulty: "medium",
        ...
        resources: [
          {
            type: "doc",
            title: "scikit-learn supervised guides",
        ...
        projects: [
          {
            title: "Credit Score Assessor",
            brief:
              "Train a Random Forest classifier on financial profiles to predict credit default risks, displaying feature importance.",
            difficulty: "medium",
          },
        ],
      },
      {
        ...
        outcome:
          "Optimize model hyperparameters using GridSearch and validate performance using ROC-AUC.",
        hours: 10,
        difficulty: "medium",
        ...
        resources: [
          {
            type: "doc",
            title: "GridSearch API Reference",
            url: "https://scikit-learn.org/stable/modules/grid_search.html",
            free: true,
          },
          {
            type: "youtube",
            title: "Model Tuning & Validation",
            url: "https://www.youtube.com/watch?v=fNk_zzaMoSs",
            videoId: "fNk_zzaMoSs",
            channel: "3Blue1Brown",
            free: true,
        ...
        projects: [
          {
            title: "Optimal Grid Tuning Engine",
            brief:
              "Perform GridSearch on an SVM, benchmarking radial vs linear kernels, and outputting confusion matrices.",
            difficulty: "medium",
          },
        ],
      },
    ...
    advanced: [
      {
        ...
        prerequisites: [],
        outcome:
          "Train XGBoost models, configure learning rates, and handle missing values automatically.",
        hours: 15,
        difficulty: "hard",
        ...
        projects: [
          {
            ...
            brief:
              "Apply XGBoost to classify subscription cancellation risks, using early stopping to prevent over-training.",
            difficulty: "hard",
          },
        ],
      },
    ...
    intermediate: [
      {
        ...
        prerequisites: [],
        outcome:
          "Design classes, override magic methods (__str__, __init__), and apply polymorphism.",
        hours: 8,
        difficulty: "medium",
        ...
        projects: [
          {
            title: "Banking Account Manager",
            brief:
              "Build an account system supporting savings/checking classes, deposit validations, and custom exception handling.",
            difficulty: "medium",
          },
        ],
      },
      {
        ...
        projects: [
          {
            title: "Telemetry Logging decorator",
            brief:
              "Write a `@log_runtime` decorator tracking and outputting function execution duration.",
            difficulty: "medium",
          },
        ],
      },
    ...
    advanced: [
      {
        ...
        prerequisites: [],
        outcome:
          "Write asynchronous code using asyncio event loops and launch multiprocessing pools.",
        hours: 14,
        difficulty: "hard",
        ...
        projects: [
          {
            title: "Async Image Downloader",
            brief:
              "Write an asyncio downloader fetching multiple images concurrently, managing connection pools.",
            difficulty: "hard",
          },
        ],
      },
    ...
    intermediate: [
      {
        ...
        prerequisites: [],
        outcome:
          "Write task definitions, launch ECS clusters, and manage load balanced container groups.",
        hours: 12,
        difficulty: "medium",
        ...
        resources: [
          ...
          {
            type: "youtube",
            title: "AWS ECS & Fargate Tutorial",
            url: "https://www.youtube.com/watch?v=a9__D53WsUs",
            videoId: "a9__D53WsUs",
            channel: "Fireship",
            free: true,
        ...
        projects: [
          {
            title: "Fargate Container API",
            brief:
              "Deploy an Express API container on AWS Fargate behind an Application Load Balancer.",
            difficulty: "medium",
          },
        ],
      },
    ...
    advanced: [
      {
        ...
        projects: [
          {
            title: "CDK Serverless API stack",
            brief:
              "Write a CDK stack provisioning a DynamoDB table, a Lambda solver, and an API Gateway endpoint.",
            difficulty: "hard",
          },
        ],
      },
