...
import { u as useAuth, k as getPlanetForXP, l as PLANETARY_LEVELS, d as PageShell, S as SharedCanvas, a as playHover, p as playClick, H as HolographicPanel } from "./_ssr/router-DT2A3-T4.mjs";
...
const UniverseMap = reactExports.lazy(() => import("./_ssr/UniverseMapCanvas-CW7c8443.mjs"));
function Dashboard() {
  const {
    user
  } = useAuth();
