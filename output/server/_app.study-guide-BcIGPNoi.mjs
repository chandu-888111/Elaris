...
import { g as generateStudyGuide } from "./_ssr/ai.functions-ClHaPUvy.mjs";
import { u as useAuth, R as Route$t, d as PageShell, e as PageHeader, H as HolographicPanel, f as awardXP, X as XP, g as unlockAchievement } from "./_ssr/router-DT2A3-T4.mjs";
...
const LibraryCanvas = reactExports.lazy(() => import("./_ssr/LibraryCanvas-e5wBAVJG.mjs"));
