        ...
        projects: [
          {
            ...
            brief: "Write an ArrayList from scratch with push, pop, insert, delete, and automatic doubling.",
            difficulty: "easy"
          }
        ]
      },
        ...
        projects: [
          {
            ...
            brief: "Implement insertAtHead, insertAtTail, deleteNode, reverseList, and detectCycle.",
            difficulty: "easy"
          }
        ]
      },
        ...
        projects: [
          {
            ...
            brief: "Write a program that uses a stack to parse strings and check for balanced brackets.",
            difficulty: "easy"
          }
        ]
      },
        ...
        projects: [
          {
            ...
            brief: "Write an interactive console app highlighting swaps in Bubble, Selection, and Insertion sorts.",
            difficulty: "easy"
          }
        ]
      },
        ...
        projects: [
          {
            ...
            brief: "Find the index of an element in a sorted array that has been rotated, using binary search.",
            difficulty: "medium"
          }
        ]
      }
        ...
        projects: [
          {
            ...
            brief: "Merge K sorted lists into a single sorted list using a Min-Heap/Priority Queue.",
            difficulty: "medium"
          }
        ]
      },
        ...
        projects: [
          {
            ...
            brief: "Build a grid maze solver that finds the shortest path from start to end using BFS.",
            difficulty: "medium"
          }
        ]
      },
        ...
        projects: [
          {
            ...
            brief: "Write a Hash Map from scratch with custom hash function, resizing, and chaining.",
            difficulty: "medium"
          }
        ]
      },
        ...
        projects: [
          {
            ...
            brief: "Compare Quick Sort performance using first-element, last-element, and median-of-three pivot strategies.",
            difficulty: "medium"
          }
        ]
      }
        ...
        projects: [
          {
            ...
            brief: "Build an interactive tool that solves the 0/1 Knapsack problem using tabulation, displaying the matrix step-by-step.",
            difficulty: "hard"
          }
        ]
      },
        ...
        projects: [
          {
            ...
            brief: "Simulate a router network finding shortest paths and adapting dynamically when a node goes offline.",
            difficulty: "hard"
          }
        ]
      },
        ...
        projects: [
          {
            ...
            brief: "Build a memory-efficient autocomplete system that returns suggestion words based on prefix query in real time.",
            difficulty: "hard"
          }
        ]
      },
        ...
        projects: [
          {
            ...
            brief: "Build a system that handles thousands of numerical range queries and updates on a large floating list.",
            difficulty: "hard"
          }
        ]
      },
        ...
        projects: [
          {
            ...
            brief: "Implement a Space-efficient BitSet class mapping indices to single bits, with intersection and union.",
            difficulty: "hard"
          }
        ]
      }
        ...
        projects: [
          {
            ...
            brief: "Write a script that isolates specific colored objects (e.g. green balls) using HSV color space thresholds.",
            difficulty: "easy"
          }
        ]
      },
        ...
        projects: [
          {
            ...
            brief: "Write a pure NumPy convolution function applying edge-detection and sharpening kernels.",
            difficulty: "easy"
          }
        ]
      },
        ...
        projects: [
          {
            ...
            brief: "Given a photo of a document, detect edges, isolate the outline contour, and apply a perspective warp.",
            difficulty: "medium"
          }
        ]
      }
        ...
        projects: [
          {
            ...
            brief: "Align and stitch two overlapping photos into a single widescreen panorama using keypoint matching and homography.",
            difficulty: "medium"
          }
        ]
      },
        ...
        projects: [
          {
            ...
            brief: "Train a Support Vector Machine on HOG features to classify images as 'pedestrian' or 'background'.",
            difficulty: "medium"
          }
        ]
      },
        ...
        projects: [
          {
            ...
            brief: "Build a PyTorch CNN class to classify handwritten digits with validation scoring and model checkpoints.",
            difficulty: "medium"
          }
        ]
      }
        ...
        projects: [
          {
            ...
            brief: "Build a Python program streaming webcam frames through YOLO, drawing bounding boxes and labels at >30 FPS.",
            difficulty: "hard"
          }
        ]
      },
        ...
        projects: [
          {
            ...
            brief: "Train a U-Net model on road imagery to segments drivable lane regions from surrounding backgrounds.",
            difficulty: "hard"
          }
        ]
      },
        ...
        projects: [
          {
            ...
            brief: "Fine-tune a Google ViT model from Hugging Face on a custom dataset (e.g. flower categories).",
            difficulty: "hard"
          }
        ]
      }
        ...
        projects: [
          {
            ...
            brief: "Write a command-line tool that fetches data from an API, parses headers, and displays body metrics.",
            difficulty: "easy"
          }
        ]
      },
        ...
        projects: [
          {
            ...
            brief: "Create a deployment automation script checking server status, cloning a repo, and launching it.",
            difficulty: "easy"
          }
        ]
      },
        ...
        projects: [
          {
            ...
            brief: "Design and implement tables for users, orders, and products with referential integrity.",
            difficulty: "easy"
          }
        ]
      }
        ...
        projects: [
          {
            ...
            brief: "Build an API supporting CRUD operations, query-parameter filters, and server-side logging.",
            difficulty: "medium"
          }
        ]
      },
        ...
        projects: [
          {
            ...
            brief: "Build a Node/Express service with user login, JWT tokens, and route authorization protection.",
            difficulty: "medium"
          }
        ]
      },
        ...
        projects: [
          {
            ...
            brief: "Write a Docker Compose file to run a backend container linked with a PostgreSQL container.",
            difficulty: "medium"
          }
        ]
      }
        ...
        projects: [
          {
            ...
            brief: "Build a microservice caching geocode endpoints in Redis for 10 minutes to minimize external calls.",
            difficulty: "hard"
          }
        ]
      },
        ...
        projects: [
          {
            ...
            brief: "An API receives receipt details, pushes to RabbitMQ, and a background worker generates and saves the PDF.",
            difficulty: "hard"
          }
        ]
      },
        ...
        projects: [
          {
            ...
            brief: "Configure Nginx to route incoming traffic across three identical instances of your backend Node service.",
            difficulty: "hard"
          }
        ]
      }
        ...
        projects: [
          {
            ...
            brief: "Build an interactive product card grid that shifts seamlessly from mobile screens to multi-column desktop.",
            difficulty: "easy"
          }
        ]
      },
        ...
        projects: [
          {
            ...
            brief: "Fetch temperature details from an open API, update DOM elements, and support location searches.",
            difficulty: "easy"
          }
        ]
      }
        ...
        projects: [
          {
            ...
            brief: "Build an app featuring dynamic state tracking: adding items, adjusting quantities, and rendering totals.",
            difficulty: "medium"
          }
        ]
      },
        ...
        projects: [
          {
            ...
            brief: "Create a complex dashboard featuring menus, graphs, sidebar grids, and dark modes using Tailwind CSS.",
            difficulty: "medium"
          }
        ]
      }
        ...
        projects: [
          {
            ...
            brief: "Take an unoptimized web project, split code paths, compress images, and raise Lighthouse scores from 40 to 95.",
            difficulty: "hard"
          }
        ]
      },
        ...
        projects: [
          {
            ...
            brief: "Build a blog that renders metadata server-side and uses dynamic static paths for rapid article loads.",
            difficulty: "hard"
          }
        ]
      }
        ...
        projects: [
          {
            ...
            brief: "Write a bash script checking system log files for critical failures and emailing reports when found.",
            difficulty: "easy"
          }
        ]
      }
        ...
        projects: [
          {
            ...
            brief: "Build a Docker Compose recipe coordinating a Node web app, a Redis cache, and a PostgreSQL database.",
            difficulty: "medium"
          }
        ]
      },
        ...
        projects: [
          {
            ...
            brief: "Write a GitHub Actions file that runs tests, builds a Docker image, and pushes it to Docker Hub on branch updates.",
            difficulty: "medium"
          }
        ]
      },
        ...
        projects: [
          {
            ...
            brief: "Write Terraform config setting up a secure subnet, spinning up an EC2 instance, and attaching a public IP.",
            difficulty: "medium"
          }
        ]
      }
        ...
        projects: [
          {
            ...
            brief: "Deploy an Express API container cluster on Minikube with load balancing and rolling update policies.",
            difficulty: "hard"
          }
        ]
      },
        ...
        projects: [
          {
            ...
            brief: "Expose query time metrics on a backend API, scrape via Prometheus, and build a Grafana analytics dashboard.",
            difficulty: "hard"
          }
        ]
      }
        ...
        projects: [
          {
            ...
            brief: "Design a full system topology map highlighting DNS lookups, CDNs, load balancers, web instances, and DB layers.",
            difficulty: "easy"
          }
        ]
      },
        ...
        projects: [
          {
            ...
            brief: "Calculate server CPU, RAM, and bandwidth requirements to support 10 million daily active users.",
            difficulty: "easy"
          }
        ]
      }
        ...
        projects: [
          {
            ...
            brief: "Write an Nginx config routing client traffic to three Express backend servers running locally.",
            difficulty: "medium"
          }
        ]
      },
        ...
        projects: [
          {
            ...
            brief: "Build an API middleware that checks Redis first and falls back to a mock database, logging hit/miss statistics.",
            difficulty: "medium"
          }
        ]
      }
        ...
        projects: [
          {
            ...
            brief: "Build an order service communicating with an inventory service via gRPC messages.",
            difficulty: "hard"
          }
        ]
      },
        ...
        projects: [
          {
            ...
            brief: "Write a small visualization demonstrating leader election and data replication across three local nodes.",
            difficulty: "hard"
          }
        ]
      }
        ...
        projects: [
          {
            ...
            brief: "Write a calculator module supporting basic mathematical inputs and printing results.",
            difficulty: "easy"
          }
        ]
      }
        ...
        projects: [
          {
            ...
            brief: "Build an interface that fetches trending GIFs from the Giphy API and updates image nodes asynchronously.",
            difficulty: "medium"
          }
        ]
      }
        ...
        projects: [
          {
            ...
            brief: "Write a function returning getter/setter functions protecting internal variable objects from direct mutations.",
            difficulty: "hard"
          }
        ]
      }
        ...
        projects: [
          {
            ...
            brief: "Refactor a JS calculation module to strict TS with typed arguments and return signatures.",
            difficulty: "easy"
          }
        ]
      }
        ...
        projects: [
          {
            ...
            brief: "Write an API client class wrapping fetch calls returning strictly-typed JSON responses.",
            difficulty: "medium"
          }
        ]
      }
        ...
        projects: [
          {
            ...
            brief: "Write types mapped from schemas where ID is mandatory, some fields are read-only, and updates are Partial.",
            difficulty: "hard"
          }
        ]
      }
        ...
        projects: [
          {
            ...
            brief: "Write a perceptron class in Python that learns AND/OR logic gates after training on truth tables.",
            difficulty: "easy"
          }
        ]
      }
        ...
        projects: [
          {
            ...
            brief: "Build a multi-layer neural network using only NumPy, implementing forward, backward, and weight update loops.",
            difficulty: "medium"
          }
        ]
      }
        ...
        projects: [
          {
            ...
            brief: "Implement a small decoder-only Transformer model in PyTorch and train it on a short text file to generate prose.",
            difficulty: "hard"
          }
        ]
      }
        ...
        projects: [
          {
            ...
            brief: "Write a script calling the Gemini API that translates input text into a user-specified language, with validation logging.",
            difficulty: "easy"
          }
        ]
      }
    ...
    intermediate: [
      {
        ...
        projects: [
          {
            title: "Q&A PDF Bot",
            brief: "Build an application loading text from a PDF, chunking it, indexing it in ChromaDB, and answering queries via Gemini.",
            difficulty: "medium"
          }
        ]
      }
        ...
        projects: [
          {
            ...
            brief: "Build an agent that receives a topic, calls a search tool, compiles citations, and prints a Markdown summary.",
            difficulty: "hard"
          }
        ]
      }
        ...
        projects: [
          {
            ...
            brief: "Use Wireshark to capture local HTTP requests, locate plaintext parameters, and document leak vulnerabilities.",
            difficulty: "easy"
          }
        ]
      }
        ...
        projects: [
          {
            ...
            brief: "Audit a mockup web app, perform SQL injection tests, patch input queries, and write a mitigation report.",
            difficulty: "medium"
          }
        ]
      }
        ...
        projects: [
          {
            ...
            brief: "Configure a local virtual network, scan an unpatched OS container, run an exploit module, and patch the service.",
            difficulty: "hard"
          }
        ]
      }
        ...
        projects: [
          {
            ...
            brief: "Train a Random Forest classifier on financial profiles to predict credit default risks, displaying feature importance.",
            difficulty: "medium"
          }
        ]
      },
        ...
        projects: [
          {
            ...
            brief: "Perform GridSearch on an SVM, benchmarking radial vs linear kernels, and outputting confusion matrices.",
            difficulty: "medium"
          }
        ]
      }
        ...
        projects: [
          {
            ...
            brief: "Apply XGBoost to classify subscription cancellation risks, using early stopping to prevent over-training.",
            difficulty: "hard"
          }
        ]
      }
        ...
        projects: [
          {
            ...
            brief: "Build an account system supporting savings/checking classes, deposit validations, and custom exception handling.",
            difficulty: "medium"
          }
        ]
      },
        ...
        projects: [
          {
            ...
            brief: "Write a `@log_runtime` decorator tracking and outputting function execution duration.",
            difficulty: "medium"
          }
        ]
      }
        ...
        projects: [
          {
            ...
            brief: "Write an asyncio downloader fetching multiple images concurrently, managing connection pools.",
            difficulty: "hard"
          }
        ]
      }
        ...
        projects: [
          {
            ...
            brief: "Deploy an Express API container on AWS Fargate behind an Application Load Balancer.",
            difficulty: "medium"
          }
        ]
      }
        ...
        projects: [
          {
            ...
            brief: "Write a CDK stack provisioning a DynamoDB table, a Lambda solver, and an API Gateway endpoint.",
            difficulty: "hard"
          }
        ]
      }
