...
const YOUTUBE_LIBRARY = {
  ...
  nextjs: [
    {
      ...
      channel: "Traversy Media",
      videoId: "ZjAqacq_ToI",
      url: "https://www.youtube.com/watch?v=ZjAqacq_ToI",
      duration: "1h 45m",
      rating: 4.8
    },
    {
      title: "Next.js 14 in 100 Seconds",
      channel: "Fireship",
      videoId: "Sklc_fSGryY",
      url: "https://www.youtube.com/watch?v=Sklc_fSGryY",
      duration: "2m",
      rating: 4.9
    }
  ],
  javascript: [
    ...
    },
    {
      ...
      videoId: "W6NZ1r0KB9A",
      url: "https://www.youtube.com/watch?v=W6NZ1r0KB9A",
      duration: "1h 10m",
      rating: 4.8
    }
  ],
  typescript: [
    {
      ...
      channel: "Net Ninja",
      videoId: "2pZmEmXL0nY",
      url: "https://www.youtube.com/watch?v=2pZmEmXL0nY",
      duration: "1h 20m",
      rating: 4.8
    },
    {
  ...
  docker: [
    {
      ...
      channel: "freeCodeCamp",
      videoId: "3c-iKanqdEc",
      url: "https://www.youtube.com/watch?v=3c-iKanqdEc",
      duration: "2h 45m",
      rating: 4.8
    },
    {
      ...
      channel: "Fireship",
      videoId: "gAkwW2tuIq8",
      url: "https://www.youtube.com/watch?v=gAkwW2tuIq8",
      duration: "2m",
      rating: 4.9
    }
  ],
  kubernetes: [
    ...
    },
    {
      ...
      channel: "Fireship",
      videoId: "Pz-YIIU67s8",
      url: "https://www.youtube.com/watch?v=Pz-YIIU67s8",
      duration: "2m",
      rating: 4.8
    }
  ],
  ...
  dsa: [
    ...
    },
    {
      ...
      videoId: "Db9yQRE60b4",
      url: "https://www.youtube.com/watch?v=Db9yQRE60b4",
      duration: "1h 15m",
      rating: 4.8
    }
  ],
  ...
  cybersecurity: [
    {
      ...
      videoId: "fNzpXM0y1aU",
      url: "https://www.youtube.com/watch?v=fNzpXM0y1aU",
      duration: "1h 50m",
      rating: 4.8
    },
    {
      ...
      channel: "freeCodeCamp",
      videoId: "fK3gN9k-X0Y",
      url: "https://www.youtube.com/watch?v=fK3gN9k-X0Y",
      duration: "2h 10m",
      rating: 4.9
    }
  ],
  git: [
    ...
    },
    {
      ...
      channel: "Fireship",
      videoId: "hw3bHdU-7v4",
      url: "https://www.youtube.com/watch?v=hw3bHdU-7v4",
      duration: "2m",
      rating: 4.9
    }
  ],
  ...
  pandas: [
    {
      ...
      channel: "Keith Galli",
      videoId: "vmEHCJof1Oo",
      url: "https://www.youtube.com/watch?v=vmEHCJof1Oo",
      duration: "1h 00m",
      rating: 4.9
    },
    {
  ...
  cloud: [
    ...
    {
      title: "Cloud Computing in 100 Seconds",
      channel: "Fireship",
      videoId: "M988_fsOSWo",
  ...
  "computer-vision": [
    {
      title: "Computer Vision Course - OpenCV & Python",
      channel: "freeCodeCamp",
      videoId: "oXlwWbU8l2o",
    ...
    {
      title: "OpenCV Python Tutorial for Beginners",
...
function matchKey(text) {
  ...
  if (t.includes("cloud computing") || t.includes("cloud fundamentals") || t.includes("cloud architecture"))
    return "cloud";
  ...
  if (t.includes("aws") || t.includes("cloud") || t.includes("lambda") || t.includes("s3") || t.includes("ec2"))
    return "aws";
  if (t.includes("dsa") || t.includes("algorithm") || t.includes("tree") || t.includes("list") || t.includes("graph"))
    return "dsa";
  if (t.includes("vision") || t.includes("opencv") || t.includes("image processing") || t.includes("yolo") || t.includes("cv"))
    return "computer-vision";
  if (t.includes("ai ") || t.includes("machine learning") || t.includes("neural") || t.includes("model") || t.includes("tensor") || t.includes("pytorch") || t.includes("deep learning"))
    return "ai";
  if (t.includes("security") || t.includes("cyber") || t.includes("owasp") || t.includes("exploit") || t.includes("crack"))
    return "cybersecurity";
  if (t.includes("git")) return "git";
  if (t.includes("sql") || t.includes("postgres") || t.includes("mongo") || t.includes("database") || t.includes("query") || t.includes("nosql"))
    return "sql";
...
function getPracticeDomain(key) {
...
function getFallbackInterviewQuestions(topic, key) {
  const normKey = key || "general";
  const library = {
    react: [
      {
        question: "What is the Virtual DOM and how does React use it?",
        answer: "React builds an in-memory cache of the UI structure (the Virtual DOM). When state updates, React renders a new virtual tree, computes the diff (reconciliation) against the real DOM, and updates only the changed nodes for high performance."
      },
      {
        question: "What are React Hooks and what rules govern them?",
        answer: "Hooks are functions that let you hook into React state and lifecycle features from functional components. Rules: 1. Only call Hooks at the top level (not inside loops or conditions). 2. Only call Hooks from React Function Components or Custom Hooks."
      },
      {
        question: "What is the difference between props and state?",
        answer: "Props are read-only inputs passed into a component by its parent, used to configure it. State is a private, mutable data store managed internally by the component itself to track interactive changes."
      }
    ],
    nextjs: [
      {
        question: "What is the difference between Server Components and Client Components in Next.js?",
        answer: "Server Components are rendered on the server, meaning they send zero JavaScript to the client, improving load speed. Client Components are hydrated on the client, enabling interactivity (like useState, event listeners, and browser APIs). Use 'use client' to declare them."
      },
      {
        question: "What are SSR, SSG, and ISR in Next.js?",
        answer: "SSR (Server-Side Rendering) fetches data and renders pages on every request. SSG (Static Site Generation) compiles pages once at build time. ISR (Incremental Static Regeneration) rebuilds static pages in the background after a specified interval when requests come in."
      }
    ],
    javascript: [
      {
        question: "Explain event delegation in JavaScript.",
        answer: "Event delegation is a technique where you attach a single event listener to a parent element rather than multiple listeners to individual child elements. It relies on event bubbling, where the event propagates up through child nodes to the parent."
      },
      {
        question: "What is a closure in JavaScript?",
        answer: "A closure is the combination of a function bundled together with references to its surrounding state (the lexical environment). Closures allow an inner function to access variables from an outer function scope even after the outer function has completed execution."
      }
    ],
    typescript: [
      {
        question: "What is the difference between an Interface and a Type Alias in TypeScript?",
        answer: "Interfaces are extendable via declaration merging (you can declare the same interface twice and they merge) and are preferred for objects. Type Aliases can define primitives, unions, and tuples, but cannot be reopened to add new properties."
      },
      {
        question: "What are generics in TypeScript?",
        answer: "Generics allow you to build reusable components or functions that work over a variety of types rather than a single one, preserving type safety (e.g. `Array<T>` or `Promise<T>`)."
      }
    ],
    python: [
      {
        question: "How does memory management work in Python?",
        answer: "Python manages memory via a private heap space that holds all Python objects. The Python interpreter allocates heap space automatically and recovers unused space via a built-in garbage collector that counts references and handles cyclic references."
      },
      {
        question: "What are list comprehensions and generator expressions?",
        answer: "List comprehensions offer a concise syntax to create lists (e.g. `[x*2 for x in items]`). Generator expressions use parentheses and yield values one at a time lazily (e.g. `(x*2 for x in items)`), saving memory on large streams."
      }
    ],
    docker: [
      {
        question: "What is the difference between a Docker Image and a Docker Container?",
        answer: "A Docker Image is a read-only, static template containing instructions for creating a container (like a blueprint). A Docker Container is a running, writeable instance of an image running in isolation."
      },
      {
        question: "Explain the purpose of Docker Compose.",
        answer: "Docker Compose is a tool for defining and running multi-container Docker applications. You declare your services, networks, and volumes in a single `docker-compose.yml` file, and deploy the entire stack using `docker-compose up`."
      }
    ],
    kubernetes: [
      {
        question: "What is a Pod in Kubernetes?",
        answer: "A Pod is the smallest deployable unit in Kubernetes. It represents a single instance of a running process and can contain one or more tightly coupled containers sharing storage and network IP addresses."
      },
      {
        question: "What does a Kubernetes Service do?",
        answer: "A Service is an abstraction that defines a logical set of Pods and a policy to access them. It provides a stable network IP address and DNS name, acting as a load balancer to route traffic across dynamic Pods."
      }
    ],
    aws: [
      {
        question: "Explain the difference between AWS IAM Roles and IAM Users.",
        answer: "An IAM User is a permanent identity associated with a specific person or application with credentials (password/access keys). An IAM Role is an identity with temporary permissions that can be assumed by any trusted entity (like an EC2 instance or Lambda)."
      },
      {
        question: "What is AWS Lambda?",
        answer: "AWS Lambda is a serverless compute service that runs your code in response to events (e.g., S3 upload, API request) and automatically manages the underlying compute infrastructure, billing you only for active execution time."
      }
    ],
    dsa: [
      {
        question: "What is the time complexity of searching in a Hash Map vs a Binary Search Tree?",
        answer: "A Hash Map offers O(1) average time complexity for searches, but can degrade to O(N) in case of high hash collisions. A Balanced Binary Search Tree offers O(log N) search complexity in both average and worst cases."
      },
      {
        question: "Explain the difference between Depth First Search (DFS) and Breadth First Search (BFS) in graphs.",
        answer: "DFS explores as deep as possible along each branch before backtracking, utilizing a Stack (or recursion). BFS explores all neighbor nodes at the current depth before moving to nodes at the next level, utilizing a Queue."
      }
    ],
    cybersecurity: [
      {
        question: "What is Cross-Site Scripting (XSS) and how do you prevent it?",
        answer: "XSS is a vulnerability where malicious scripts are injected into trusted websites and executed in user browsers. Prevention: Sanitizing and encoding all user input before rendering it in the DOM, and setting robust Content Security Policies (CSP)."
      },
      {
        question: "What is the purpose of a Salt in cryptography and password hashing?",
        answer: "A Salt is a random string of data appended to a password before hashing. It ensures that identical passwords yield completely different hashes, protecting against pre-computed table attacks (Rainbow Tables)."
      }
    ],
    git: [
      {
        question: "What is the difference between git merge and git rebase?",
        answer: "Git merge joins two branches together by creating a new merge commit, preserving historical context. Git rebase moves the entire commit history of a branch onto the tip of another branch, producing a clean, linear history."
      }
    ],
    sql: [
      {
        question: "What are database Indexes and what are their tradeoffs?",
        answer: "Indexes are data structures (typically B-Trees) that speed up database query retrieval. Tradeoff: They slow down write operations (INSERT, UPDATE, DELETE) because the index must be updated, and they consume additional storage disk space."
      }
    ],
    general: [
      {
        question: "What is Clean Code and why is it important?",
        answer: "Clean Code is code that is easy to read, write, and maintain by other developers. It includes sensible naming, single-responsibility functions, extensive testing, and minimal duplication, preventing technical debt."
      }
    ]
  };
  return library[normKey] || library.general;
}
function enrichRoadmapNode(node, domainSlug) {
  const enriched = { ...node };
  ...
  const resources = [];
  const docSrc = key && OFFICIAL_DOCS[key] ? OFFICIAL_DOCS[key] : OFFICIAL_DOCS[domainSlug] ? OFFICIAL_DOCS[domainSlug] : null;
  if (docSrc) {
    resources.push({
      type: "doc",
...
function getFallbackMindmapAndResources(nodeTitle, domainSlug, tier) {
  const dummyNode = {
    id: "temp",
    title: nodeTitle,
    why: "",
  ...
  let branches = [
    {
      ...
      info: `Foundational pillars and basics of ${nodeTitle}`,
      source: docUrl
    },
    {
      label: "Ecosystem Tools",
      info: `Required developer tooling and libraries for ${nodeTitle}`,
      source: `https://github.com/search?q=${encodeURIComponent(nodeTitle)}`
    },
    {
      label: "Practical Projects",
      info: `Hands-on application and capstone projects`,
      source: `https://github.com/search?q=${encodeURIComponent(nodeTitle + " starter")}`
    },
    {
      label: "Interview Success",
      info: `Key test concepts, system design, and algorithms`,
  ...
  if (key === "react") {
    branches = [
      {
        label: "JSX & Elements",
        info: "Declarative UI structure and compilation in React",
        source: "https://react.dev/learn/writing-markup-with-jsx"
      },
      {
        label: "State & Hooks",
        info: "Managing local reactivity using useState, useEffect, and custom hooks",
        source: "https://react.dev/reference/react"
      },
      {
        label: "Reconciliation",
        info: "Virtual DOM diffing algorithm that optimizes rendering updates",
        source: "https://react.dev/learn/render-and-commit"
      },
      {
        label: "Data Flow",
        info: "Unidirectional state propagation via props and Context API",
    ...
    branches = [
      {
        label: "App Router",
        info: "File-system routing with layouts, pages, and loading UI states",
        source: "https://nextjs.org/docs/app/building-your-application/routing"
      },
      {
        label: "Server Components",
        info: "React Server Components (RSC) rendered on the server for speed",
        source: "https://nextjs.org/docs/app/building-your-application/rendering/server-components"
      },
      {
        label: "Data Rendering",
        info: "Static generation, server rendering, and incremental regeneration (ISR)",
        source: "https://nextjs.org/docs/app/building-your-application/data-fetching"
      },
      {
        label: "Optimizations",
        info: "Built-in image loader, script optimizer, and font bundles",
    ...
    branches = [
      {
        label: "Core Syntax",
        info: "Variables, control flows, loops, and list comprehensions",
        source: "https://docs.python.org/3/tutorial/controlflow.html"
      },
      {
        label: "Data Layouts",
        info: "Built-in structures: lists, dicts, sets, and tuples",
        source: "https://docs.python.org/3/tutorial/datastructures.html"
      },
      {
        label: "OOP Features",
        info: "Classes, inheritance, magic methods, and encapsulation",
        source: "https://docs.python.org/3/tutorial/classes.html"
      },
      {
        label: "Standard Library",
        info: "Built-in modules like os, sys, datetime, and json",
    ...
    branches = [
      {
        label: "DataFrames & Series",
        info: "Core 1D and 2D labeled data structures in Pandas",
        source: "https://pandas.pydata.org/docs/user_guide/dsintro.html"
      },
      {
        label: "Data Cleaning",
        info: "Handling missing values, dropping duplicates, and filtering rows",
        source: "https://pandas.pydata.org/docs/user_guide/missing_data.html"
      },
      {
        label: "Grouping & Aggs",
        info: "Split-apply-combine techniques using groupby and aggregation functions",
        source: "https://pandas.pydata.org/docs/user_guide/groupby.html"
      },
      {
        label: "File I/O",
        info: "Reading and writing CSV, Excel, JSON, and Parquet data formats",
    ...
    branches = [
      {
        label: "Infrastructure Models",
        info: "IaaS, PaaS, SaaS delivery models and public/private clouds",
        source: "https://aws.amazon.com/what-is-cloud-computing/"
      },
      {
        label: "Virtual Compute",
        info: "Running scalable virtual machine instances and workloads",
        source: "https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/concepts.html"
      },
      {
        label: "Object Storage",
        info: "Highly scalable and durable cloud object stores",
        source: "https://docs.aws.amazon.com/AmazonS3/latest/userguide/Welcome.html"
      },
      {
        label: "Cloud Networking",
        info: "Virtual networks, subnets, route tables, and edge CDNs",
    ...
    branches = [
      {
        label: "Docker Images",
        info: "Read-only templates defined by Dockerfiles to configure runtimes",
        source: "https://docs.docker.com/engine/reference/builder/"
      },
      {
        label: "Containers",
        info: "Isolated runnable instances of images executing inside sandboxes",
        source: "https://docs.docker.com/engine/reference/run/"
      },
      {
        label: "Compose Stack",
        info: "Orchestrating multi-container systems using docker-compose.yml",
        source: "https://docs.docker.com/compose/"
      },
      {
        label: "Volume & Network",
        info: "Persistent folder mounting and isolated container bridges",
    ...
    branches = [
      {
        ...
        info: "Tightly coupled container groups sharing local network IPs",
        source: "https://kubernetes.io/docs/concepts/workloads/pods/"
      },
      {
        label: "Controllers",
        info: "Deployments and ReplicaSets ensuring correct pod copies are alive",
        source: "https://kubernetes.io/docs/concepts/workloads/controllers/deployment/"
      },
      {
        label: "Service Load",
        info: "Service load balancer routing to active pods",
        source: "https://kubernetes.io/docs/concepts/services-networking/service/"
      },
      {
        label: "Config & Secret",
        info: "Mounting environment files and sensitive auth keys safely",
    ...
    branches = [
      {
        label: "Identity (IAM)",
        info: "Managing least-privilege access keys, roles, and user policies",
        source: "https://docs.aws.amazon.com/IAM/latest/UserGuide/introduction.html"
      },
      {
        label: "Compute Services",
        info: "Virtual servers (EC2) and serverless function executors (Lambda)",
        source: "https://docs.aws.amazon.com/lambda/latest/dg/welcome.html"
      },
      {
        label: "Networking (VPC)",
        info: "Isolated networks, subnets, route tables, and gateways",
        source: "https://docs.aws.amazon.com/vpc/latest/userguide/what-is-amazon-vpc.html"
      },
      {
        label: "Storage (S3)",
        info: "Highly durable key-value object store for static payloads",
        source: "https://docs.aws.amazon.com/AmazonS3/latest/userguide/Welcome.html"
      }
    ];
  } else if (key === "sql") {
    branches = [
      {
        label: "DDL Schemas",
        info: "Defining tables, columns, constraints, and foreign key relations",
        source: "https://www.postgresql.org/docs/current/ddl.html"
      },
      {
        label: "DML Queries",
        info: "Selecting, inserting, updating, and deleting records dynamically",
        source: "https://www.postgresql.org/docs/current/dml.html"
      },
      {
        label: "Table Joins",
        info: "Combining datasets via INNER, LEFT, RIGHT, and FULL queries",
        source: "https://www.postgresql.org/docs/current/queries-join.html"
      },
      {
        label: "Query Speed",
        info: "Adding B-Tree indexes, analyzing query plans, and optimizing slow scans",
  ...
  branches.forEach((b, idx) => {
    ...
    const leaves = [
      {
        label: `${b.label} Part A`,
        info: `Detailed implementation details for ${b.label} subtopics.`
      },
      {
        label: `${b.label} Part B`,
        info: `Advanced optimization and architectural patterns for ${b.label}.`
      }
    ];
...
export {
  enrichRoadmapNode as e,
  getFallbackMindmapAndResources as g,
  matchKey as m
};
