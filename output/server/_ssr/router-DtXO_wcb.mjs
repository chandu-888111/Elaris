...
import { u as useServerFn, c as createServerFn, a as createSsrRpc } from "./ai-BioNg-KZ.mjs";
...
const FloatingAICore = React.forwardRef((props, ref) => {
...
function GlobalCanvas() {
  const sunRef = reactExports.useRef(null);
  const glowColor = "#03000a";
  const currentScene = useSceneStore((s) => s.currentScene);
  const graphicsMode = useSceneStore((s) => s.graphicsMode);
  const particlesIntensity = graphicsMode === "ultra" ? 1.5 : graphicsMode === "high" ? 1 : 0.5;
    ...
    "div",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        Canvas,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("fog", { attach: "fog", args: [glowColor, 5, 40] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(reactExports.Suspense, { fallback: null, children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(FloatingAICore, { ref: sunRef }),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(dt, { multisampling: 0, children: [
                sunRef.current ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Ct,
                  {
                    sun: sunRef.current,
                    samples: 60,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    Canvas,
    {
      ...
      children: [
        ...
        enableBloom ? /* @__PURE__ */ jsxRuntimeExports.jsx(dt, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(wt, { luminanceThreshold: 0, luminanceSmoothing: 0.9, intensity: 0.2 }) }) : null
      ]
    }
  );
};
...
function useScrollVelocity({ smoothing = 0.1 } = { smoothing: 0.1 }) {
  const [scrollY, setScrollY] = reactExports.useState(0);
  const [delta, setDelta] = reactExports.useState(0);
  const [velocity, setVelocity] = reactExports.useState(0);
  const [smoothedVelocity, setSmoothedVelocity] = reactExports.useState(0);
  const [direction, setDirection] = reactExports.useState(0);
  const [inputType, setInputType] = reactExports.useState("wheel");
  const lastTimeRef = reactExports.useRef(performance.now());
  const lastPosRef = reactExports.useRef(0);
  const scrollYRef = reactExports.useRef(0);
  const smoothedVelocityRef = reactExports.useRef(0);
  const update = (newY, type) => {
    const now = performance.now();
    const dt2 = (now - lastTimeRef.current) / 1e3;
    const dy = newY - lastPosRef.current;
    const rawVelocity = dt2 > 0 ? dy / dt2 : 0;
    const smoothed = MathUtils.lerp(smoothedVelocityRef.current, rawVelocity, smoothing);
    setScrollY(newY);
    setDelta(dy);
...
function DebugHud() {
  ...
  reactExports.useEffect(() => {
    ...
    const tick = () => {
      ...
      if (now - lastFpsUpdate >= 500) {
        const dt2 = now - lastFpsUpdate;
        const currentFps = Math.round(frameCount * 1e3 / dt2);
        setFps(currentFps);
        setFrameTime(Math.round(dt2 / frameCount));
        frameCount = 0;
        lastFpsUpdate = now;
      }
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: panelStyle, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: headerStyle, children: "Performance" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: "GPU Tier: N/A" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      "Particle Count: ",
      particleCount
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: headerStyle, children: "Narrative" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: "Current Act: N/A" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      "Current Chapter: ",
      currentChapter
    ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: headerStyle, children: "Ship" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      "Ship Mode: ",
      shipMode
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      "Velocity: ",
      shipVelocity.toFixed(2)
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      "Bank Angle: ",
      shipBankAngle.toFixed(2)
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: "Thrust Intensity: N/A" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: headerStyle, children: "Accessibility" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      "Reduce Motion: ",
      reduceMotion ? "on" : "off"
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      "Reduce Transparency: ",
      prefersReducedTransparency ? "on" : "off"
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      "Audio Enabled: ",
      audioMuted ? "off" : "on"
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: headerStyle, children: "Input" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      "Input Type: ",
      inputType
    ] })
...
function RootComponent() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(QueryClientProvider, { client: queryClient, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(AuthProvider, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(DebugHud, {}),
...
const $$splitComponentImporter$o = () => import("./verified-vmuBKqkc.mjs");
...
const $$splitComponentImporter$n = () => import("./login-B-_plJNX.mjs");
...
const $$splitComponentImporter$m = () => import("../_app-B-COPSOM.mjs");
const Route$w = createFileRoute("/_app")({
  component: lazyRouteComponent($$splitComponentImporter$m, "component")
});
const $$splitComponentImporter$l = () => import("./index-DHYNk_rk.mjs");
...
const $$splitComponentImporter$k = () => import("../_app.study-guide-B8MgYMer.mjs");
...
const $$splitComponentImporter$j = () => import("../_app.settings-Dt930pRW.mjs");
...
const $$splitComponentImporter$h = () => import("../_app.resume-DuJnH2Ub.mjs");
...
const $$splitComponentImporter$g = () => import("../_app.resources-BPOzWCDD.mjs");
...
const $$splitComponentImporter$f = () => import("../_app.progress-D6evq3eM.mjs");
...
const $$splitComponentImporter$e = () => import("../_app.profile-C03_xFjK.mjs");
...
const $$splitComponentImporter$d = () => import("../_app.mentor-RxbuVHwB.mjs");
...
const $$splitComponentImporter$c = () => import("../_app.generator-CacY3BRU.mjs");
...
const $$splitComponentImporter$b = () => import("../_app.dashboard-D0k6z9Ep.mjs");
...
const $$splitComponentImporter$a = () => import("../_app.chat-Pp2i3SWT.mjs");
...
const $$splitComponentImporter$9 = () => import("../_app.builder-CA2E_Dgt.mjs");
...
const $$splitComponentImporter$8 = () => import("../_app.analytics-BigTRTCV.mjs");
...
const $$splitComponentImporter$7 = () => import("../_app.about-D1vc7eE2.mjs");
...
const $$splitComponentImporter$6 = () => import("../_app._-D6qFKyWp.mjs");
const Route$6 = createFileRoute("/_app/$")({
  component: lazyRouteComponent($$splitComponentImporter$6, "component")
});
const $$splitComponentImporter$5 = () => import("../_app.saved.index-DjqdsYvc.mjs");
...
const $$splitComponentImporter$4 = () => import("../_app.roadmap.index-DbJ-RNKY.mjs");
...
const $$splitComponentImporter$3 = () => import("../_app.chat.index-DQshuGc1.mjs");
const Route$3 = createFileRoute("/_app/chat/")({
  component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
const $$splitComponentImporter$2 = () => import("../_app.saved._projectId-BowvkJIQ.mjs");
...
const $$splitComponentImporter$1 = () => import("../_app.roadmap._slug-iNIMsMF_.mjs");
...
const $$splitComponentImporter = () => import("../_app.chat._threadId-DqO85obS.mjs");
reactExports.lazy(() => import("./MentorHologram-BuX1bvEX.mjs").then((m) => ({
