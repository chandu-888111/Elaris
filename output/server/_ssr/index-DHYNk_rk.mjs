...
import { b as useSceneStore, p as playClick, a as playHover } from "./router-DtXO_wcb.mjs";
...
function Landing() {
  ...
  useTransform(scrollYProgress, [0, 0.25, 0.5, 0.75, 1], [1, 1.6, 0.5, 1.3, 0.7]);
  ...
  useTransform(scrollYProgress, [0, 0.35, 0.7, 1], ["#c084fc", "#38bdf8", "#ec4899", "#818cf8"]);
  reactExports.useEffect(() => {
