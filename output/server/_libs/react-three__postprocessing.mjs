...
import { E as EffectComposer, R as RenderPass, N as NormalPass, D as DepthDownsamplingPass, a as Effect, b as EffectPass, G as GodRaysEffect, P as Pass, B as BloomEffect, V as VignetteEffect, C as ChromaticAberrationEffect, c as NoiseEffect } from "./postprocessing.mjs";
import "./maath.mjs";
...
const wt = /* @__PURE__ */ P(BloomEffect, { blendFunction: 0 }), yt = /* @__PURE__ */ P(ChromaticAberrationEffect), Ct = /* @__PURE__ */ reactExports.forwardRef(function(e, t) {
  const { camera: o } = reactExports.useContext(D), r = reactExports.useMemo(() => new GodRaysEffect(o, k(e.sun), e), [o, e]);
  return reactExports.useLayoutEffect(() => void (r.lightSource = k(e.sun)), [r, e.sun]), /* @__PURE__ */ jsxRuntimeExports.jsx("primitive", { ref: t, object: r, dispose: null });
}), At = /* @__PURE__ */ P(NoiseEffect, { blendFunction: 5 });
