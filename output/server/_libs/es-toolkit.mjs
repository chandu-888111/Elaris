...
function requireMaxBy$1() {
  ...
  const require_maxBy = /* @__PURE__ */ requireMaxBy$2();
  const require_identity = /* @__PURE__ */ requireIdentity();
  const require_iteratee = /* @__PURE__ */ requireIteratee();
...
function requireMinBy$1() {
  ...
  const require_minBy = /* @__PURE__ */ requireMinBy$2();
  const require_identity = /* @__PURE__ */ requireIdentity();
  const require_iteratee = /* @__PURE__ */ requireIteratee();
...
function requireLast$1() {
  ...
  hasRequiredLast$1 = 1;
  const require_last = /* @__PURE__ */ requireLast$2();
  const require_toArray = /* @__PURE__ */ requireToArray();
  const require_isArrayLike = /* @__PURE__ */ requireIsArrayLike();
