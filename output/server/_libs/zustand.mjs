...
const __vite_import_meta_env__$2 = { "BASE_URL": "/", "DEV": false, "MODE": "production", "PROD": true, "SSR": true, "TSS_DEV_SERVER": "false", "TSS_DEV_SSR_STYLES_BASEPATH": "/", "TSS_DEV_SSR_STYLES_ENABLED": "true", "TSS_DISABLE_CSRF_MIDDLEWARE_WARNING": "false", "TSS_INLINE_CSS_ENABLED": "false", "TSS_ROUTER_BASEPATH": "", "TSS_SERVER_FN_BASE": "/_serverFn/", "VITE_SUPABASE_PROJECT_ID": "kjvuunfirhvlurwkhwpl", "VITE_SUPABASE_PUBLISHABLE_KEY": "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImtqdnV1bmZpcmh2bHVyd2tod3BsIiwicm9sZSI6ImFub24iLCJpYXQiOjE3Nzk4MTQ0ODAsImV4cCI6MjA5NTM5MDQ4MH0.aSYulpZTwn2gsVBkIIsMMay8PQqFPtS2sT9LzJXRq-4", "VITE_SUPABASE_URL": "https://kjvuunfirhvlurwkhwpl.supabase.co" };
...
const devtoolsImpl = (fn, devtoolsOptions = {}) => (set, get, api) => {
  ...
  try {
    extensionConnector = (enabled != null ? enabled : (__vite_import_meta_env__$2 ? "production" : void 0) !== "production") && window.__REDUX_DEVTOOLS_EXTENSION__;
  } catch (e) {
  }
  ...
  if (shouldDispatchFromDevtools(api)) {
    ...
    api.dispatch = (...args) => {
      if ((__vite_import_meta_env__$2 ? "production" : void 0) !== "production" && args[0].type === "__setState" && !didWarnAboutReservedActionType) {
        console.warn(
